...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-primary/5 to-secondary/5 mt-auto">
      <div className="footer p-10 container mx-auto text-base-content">
        <div>
          <h2 className="footer-title text-primary">Chat App</h2>
        ...
        <div>
          ...
          <a href="mailto:support@chatapp.com" className="link link-hover">Email Support</a>
      ...
      <div className="footer footer-center p-4 bg-base-200 text-base-content border-t border-base-300">
        <div>
          <p className="text-sm">
            ...
            Built By <span className="text-primary font-medium">Aditya Singha</span> Using <span className="text-primary font-medium">MERN Stack</span>
          </p>
        </div>
      </div>
    </footer>
